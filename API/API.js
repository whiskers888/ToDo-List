...
export function changePass  (oldPass,newPass,callback) {
  let URL =  host + '/user/changepass'
...
export function deletAccount  (oldPass,newPass,callback) {
